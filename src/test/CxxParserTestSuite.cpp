...
TEST_CASE("cxx parser finds anonymous namespace declarations nested inside namespaces with different name as different symbol")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"namespace a\n"
		"{\n"
...
TEST_CASE("cxx parser finds anonymous namespace declarations nested inside namespaces with same name as same symbol")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"namespace a\n"
		"{\n"
...
TEST_CASE("cxx parser finds type template parameter definition of explicit partial class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds type template parameter definition of explicit partial variable template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds non type template parameter definition that depends on type template parameter of template class")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds non type template parameter definition that depends on template template parameter of template class")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds non type template parameter definition that depends on type template parameter of template template parameter")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds implicit copy constructor")
{
	...
	REQUIRE(utility::containsElement<std::wstring>(client->methods, L"public void TestClass::TestClass() <1:7 <1:7 1:15> 1:15>"));
	REQUIRE(utility::containsElement<std::wstring>(client->methods, L"public void TestClass::TestClass(const TestClass &) <1:7 <1:7 1:15> 1:15>"));
	REQUIRE(utility::containsElement<std::wstring>(client->methods, L"public void TestClass::TestClass(TestClass &&) <1:7 <1:7 1:15> 1:15>"));
}
...
TEST_CASE("cxx parser finds usage of template parameter of template member variable declaration")
{
	...
	REQUIRE(utility::containsElement<std::wstring>( // TODO: fix FAIL because usage in name qualifier is not recorded
		client->localSymbols, L"input.cc<5:20> <5:20 5:20>"
	));
}
...
TEST_CASE("cxx parser finds usage of template parameters with different depth of partial class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds usage of template template parameter of template class explicitly instantiated with concrete type argument")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds usage of template template parameter of template class explicitly instantiated with template type")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser creates single node for all possible parameter pack expansions of template function")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template<typename T>\n"
...
TEST_CASE("cxx parser finds type template argument of explicit template instantiated with function prototype")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds type template argument in non default constructor of explicit template instaitiation")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds type template argument in default constructor of explicit template instaitiation")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds type template argument in new expression of explicit template instaitiation")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds no template argument for builtin non type int template parameter of explicit template instantiation")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <int T>\n"	// use of "int"
		"class A\n"
...
TEST_CASE("cxx parser finds no template argument for builtin non type bool template parameter of explicit template instantiation")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <bool T>\n"	// use of "bool"
		"class A\n"
...
TEST_CASE("cxx parser finds non type custom reference template argument of implicit template instantiation")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"class P\n"
		"{};\n"
...
TEST_CASE("cxx parser finds no template argument for builtin non type int template parameter pack of explicit template instantiation")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <int... T>\n"	// use of "int"
		"class A\n"
...
TEST_CASE("cxx parser finds template template argument for parameter pack of explicit template instantiation")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds template member specialization for method of implicit template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds template member specialization for static variable of implicit template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds template member specialization for field of member class of implicit template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds template member specialization for member class of implicit template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A\n"
...
TEST_CASE("cxx parser finds no template argument for builtin non type int template parameter of explicit template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <int T>\n"	// use of "int"
		"class A\n"
...
TEST_CASE("cxx parser finds no template argument for builtin non type bool template parameter of explicit template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <bool T>\n"	// use of "bool"
		"class A\n"
...
TEST_CASE("cxx parser finds non type custom pointer template argument of explicit template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"class P\n"
		"{};\n"
...
TEST_CASE("cxx parser finds non type custom reference template argument of explicit template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"class P\n"
		"{};\n"
...
TEST_CASE("cxx parser finds no template argument for builtin non type int template parameter of explicit partial class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds no template argument for builtin non type bool template parameter of explicit partial class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds template argument for non type custom pointer template parameter of explicit partial class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"class P\n"
		"{};\n"
...
TEST_CASE("cxx parser finds template argument for non type custom reference template parameter of explicit partial class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"class P\n"
		"{};\n"
...
TEST_CASE("cxx parser finds non type template argument that depends on type template parameter of explicit partial class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds non type template argument that depends on template template parameter of explicit partial class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds correct order of template arguments for explicit class template specialization")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser replaces dependent template arguments of explicit template specialization with name of base template")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"class A {};\n"
...
TEST_CASE("cxx parser replaces unknown template arguments of explicit template specialization with depth and position index")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds no default argument type for non type bool template parameter of template class")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
	...
	REQUIRE(client->typeUses.size() == 1);; // only the "bool" type is recorded and nothing for the default arg
}
...
TEST_CASE("cxx parser finds explicit type template argument of explicit instantiation of template function")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <typename T>\n"
		"void test()\n"
...
TEST_CASE("cxx parser does not find default argument type for non type bool template parameter of template function")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
		"template <bool T = true>\n"
		"void test()\n"
	...
	REQUIRE(client->typeUses.size() == 2);; // only "bool" and "void" is recorded
}
...
TEST_CASE("cxx parser finds macro argument location for field definition with name passed as argument to macro")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds macro usage location for field definition with name partially passed as argument to macro")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds macro argument location for function call in code passed as argument to macro")
{
	std::shared_ptr<TestIntermediateStorage> client = parseCode(
...
TEST_CASE("cxx parser finds no duplicate braces of template class and method decl")
{
	...
	REQUIRE(client->localSymbols.size() == 9);; // 8 braces + 1 template parameter
}
